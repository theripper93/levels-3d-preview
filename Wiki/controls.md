...
### Token Interaction:
 ...
 - **Ctrl + Mouse Wheel** -> Rotate currently controlled tokens
 - **Ctrl + Click (on empty spot)** -> Deselect all tokens

Standard foundry interactions work (Left click to select, right click for HUD, Double left for sheet, Double right for config\target)
