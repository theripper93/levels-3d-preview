...
export class GlobalIllumination {
    ...
    generateTimeSpline() {
      const spline = new THREE.SplineCurve([
        ...
        new THREE.Vector2(6, Math.PI/2),
        new THREE.Vector2(12, Math.PI),
        new THREE.Vector2(20, Math.PI*3/2),
        new THREE.Vector2(24, 2*Math.PI),
      ]);
    ...
    _setShadowQuality(){
      ...
      sunlight.castShadow = !game.settings.get("levels-3d-preview", "disableLighting");
