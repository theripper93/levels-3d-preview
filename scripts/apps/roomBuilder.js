export class RoomBuilder extends FormApplication {
    ...
    static get defaultOptions() {
        return {
            ...
            template: `modules/levels-3d-preview/templates/room-builder.hbs`,
            width: 200,
            height: "auto",
            top: 0,
    ...
    activateListeners(html) {
        ...
        html.on("change", "select", (e) => {
            ...
            const theme = game.settings.get("levels-3d-preview", "roombuildeercustomthemes").find(t => t.name == value);
            if (!theme) return;
    ...
    async saveTheme() {
        ...
        const themes = game.settings.get("levels-3d-preview", "roombuildeercustomthemes");
        ...
        await game.settings.set("levels-3d-preview", "roombuildeercustomthemes", themes);
    ...
    updateSelect(selected = null) {
        ...
        const themes = game.settings.get("levels-3d-preview", "roombuildeercustomthemes").sort((a, b) => a.name.localeCompare(b.name));
