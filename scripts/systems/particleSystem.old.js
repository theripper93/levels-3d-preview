...
export class ParticleSystem {
    ...
    async resolveSocket(from, to, params) {
        ...
        const fromObjects = [];
        for(let f of from) fromObjects.push((await fromUuid(f)) ?? f);
        from = fromObjects.map((f) => f._object ?? f);
        const toObjects = []; 
        for(let t of to) toObjects.push((await fromUuid(t)) ?? t);
...
class ProjectileParticle extends BaseParticleEffect {
    constructor(from, to, params) {
        ...
        this._speed = (this.params.speed / this._dist / (factor / 100)) * ParticleSystem.getScale();
    ...
    async createEmitter() {
        ...
        this.emitter
            .setRate(new Rate(this.params.rate.particles, this.params.rate.seconds))
            .addInitializers([new Body(await this.createSprite()), new Mass(this.params.mass), new Life(this.params.life.min, this.params.life.max), new Position(new SphereZone(this.params.emitterSize)), new RadialVelocity(this.params.radial.angle, this.params.radial.direction, this.params.radial.theta)])
            .addBehaviours([new Alpha(this.params.alpha.start, this.params.alpha.end, Infinity, ease.easeInOutSine), new RandomDrift(0.001, 0.001, 0.001, 0.05), new Scale(this.params.scale.start * this.rendererScale, this.params.scale.end * this.rendererScale), new Gravity(this.params.gravity), new Force(this.params.push.dx, this.params.push.dz, this.params.push.dy), new Color(this.params.color.start, this.params.color.end, Infinity, ease.easeOutSine)]);
        
        this.emitter.setPosition(this._origin);
        this.emitter.emit();
    }
...
class ExplosionParticle extends BaseParticleEffect {
    ...
    async createEmitter() {
        ...
        this.emitter
            .setRate(new Rate(this.params.rate.particles, this.params.rate.seconds))
            .addInitializers([new Body(await this.createSprite()), new Mass(this.params.mass), new Life(this.params.life.min, this.params.life.max), new Position(new SphereZone(this.params.emitterSize)), new RadialVelocity(this.params.radial.angle, this.params.radial.direction, this.params.radial.theta)])
            .addBehaviours([new Alpha(this.params.alpha.start, this.params.alpha.end, Infinity, ease.easeInOutSine), new RandomDrift(10, 10, 10, 0.05), new Scale(this.params.scale.start * this.rendererScale, this.params.scale.end * this.rendererScale), new Gravity(this.params.gravity), new Force(this.params.push.dx, this.params.push.dz, this.params.push.dy), new Color(this.params.color.start, this.params.color.end, Infinity, ease.easeOutSine), new Repulsion(this._target, this.params.force, this.params.emitterSize, Infinity, ease.easeOutSine)]);
        
        this.emitter.setPosition(this._target);
        this.emitter.emit();
    }
...
class RayParticle extends BaseParticleEffect {
    ...
    async createEmitter() {
        ...
        this.emitter
            .setRate(new Rate(this.params.rate.particles, this.params.rate.seconds))
            .addInitializers([new Body(await this.createSprite()), new Mass(this.params.mass), new Life(this.params.life.min, this.params.life.max), new Position(new LineZone(this._origin.x, this._origin.y, this._origin.z, this._target.x, this._target.y, this._target.z)), new RadialVelocity(this.params.radial.angle, this.params.radial.direction, this.params.radial.theta)])
            .addBehaviours([new Alpha(this.params.alpha.start, this.params.alpha.end, Infinity, ease.easeInOutSine), new RandomDrift(0.001, 0.001, 0.001, 0.05), new Scale(this.params.scale.start * this.rendererScale, this.params.scale.end * this.rendererScale), new Gravity(this.params.gravity), new Force(this.params.push.dx, this.params.push.dz, this.params.push.dy), new Color(this.params.color.start, this.params.color.end, Infinity, ease.easeOutSine), new Repulsion(this._target, this.params.force, this.params.emitterSize, Infinity, ease.easeOutSine)]);
        this.emitter.emit();
    }
